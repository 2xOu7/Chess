...
public class BlackKing extends Chesspiece {
	...
	private static ImageIcon image = new ImageIcon("/Users/jonathan/Documents/Photos/blackking.png");
	public BlackKing() {
	...
	public void left_castle(Chessboard c) {
		...
		if (this.getMoves() == 0 && pawn_1.getMoves() == 0 && c.getBCheck() == false) {
			if (pawn_1 instanceof BlackRook && pawn_1.getIcon() != null) {
				boolean active = true;
				for (int i = 1; i < 4; i++) {
