...
public class WhiteRook extends Chesspiece {
	...
	private static ImageIcon image = new ImageIcon("/Users/jonathan/Documents/Photos/whiterook.png");
    	...
    	while (forward != null) {
    		if (forward.getIcon() == null) {
    			...
    			if (i == 0) {
    				...
    				forward.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1,Color.BLACK));
    			}
    		} else if (forward.getPieceColor() == Color.BLACK) {
    			forward.setBackground(Color.YELLOW);
    			if (i == 0) {
    				forward.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1,Color.BLACK));
    			} else {
    	...
    	while (back != null) {
    		if (back.getIcon() == null) {
    			...
    			if (i == 0) {
    				...
    				back.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1,Color.BLACK));
    			}
    		} else if (back.getPieceColor() == Color.BLACK) {
    			back.setBackground(Color.YELLOW);
    			if (i == 0) {
    				back.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1,Color.BLACK));
    			} else {
